    ...
    <div class="container" style="width: 50%; margin:auto; background-color: white; padding: 15px; box-shadow: 0px 0px 5px gray; border-radius: 5px;">
        <div class="row">
            <div class="col-md-12" style="font-family:Arial, Helvetica, sans-serif;">
                ...
                <p style="line-height: 1.2em;">Your payment for the upcoming event "{{$content->event->title}}" with the amount of Php @convert($content->fee->fee) has been accepted and we recognize you as paid member.</p>
